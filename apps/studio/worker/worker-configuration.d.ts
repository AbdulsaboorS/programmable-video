/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example worker/worker-configuration.d.ts` (hash: 3ff544dc827ea112d4a5f5d0751fe8ce)
// Runtime types generated with workerd@1.20260820.1 2026-09-02 nodejs_compat
interface __BaseEnv_Env {
	REVISION_SOURCES: R2Bucket;
	REVISION_PREVIEWS: R2Bucket;
	...
	ARTIFACTS_ACCOUNT_ID: "replace-with-account-id";
	ARTIFACTS_NAMESPACE: "programmable-video";
	PREVIEW_ORIGIN: "https://programmable-video-preview.example.workers.dev";
	STUDIO_ORIGIN: "https://programmable-video-studio.example.workers.dev";
	LOCAL_OWNER_EMAIL: string;
	ARTIFACTS_API_TOKEN: string;
	PREVIEW_SIGNING_KEY: string;
	STREAM_ACCOUNT_ID: string;
	STREAM_API_TOKEN: string;
	RENDERER: DurableObjectNamespace<import("./index").RendererContainer>;
	SANDBOX: DurableObjectNamespace<import("./index").Sandbox>;
	RENDER_WORKFLOW: Workflow<Parameters<import("./index").RenderWorkflow['run']>[0]['payload']>;
	REVISION_WORKFLOW: Workflow<Parameters<import("./index").RevisionWorkflow['run']>[0]['payload']>;
	MANAGED_RENDER_WORKFLOW: Workflow<Parameters<import("./index").ManagedRenderWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "RendererContainer" | "Sandbox";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BUILD_ID" | "STARTER_REPOSITORY" | "ACCESS_AUD" | "ACCESS_TEAM_DOMAIN" | "ARTIFACTS_ACCOUNT_ID" | "ARTIFACTS_NAMESPACE" | "PREVIEW_ORIGIN" | "STUDIO_ORIGIN" | "LOCAL_OWNER_EMAIL" | "ARTIFACTS_API_TOKEN" | "PREVIEW_SIGNING_KEY" | "STREAM_ACCOUNT_ID" | "STREAM_API_TOKEN">> {}
}
