/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker/worker-configuration.d.ts` (hash: 64e16d2eaab22cfc33642fca31b64e60)
...
interface __BaseEnv_Env {
  ...
  RENDER_WORKFLOW: Workflow<
    Parameters<import("./index").RenderWorkflow["run"]>[0]["payload"]
  >;
  REVISION_WORKFLOW: Workflow<
    Parameters<import("./index").RevisionWorkflow["run"]>[0]["payload"]
  >;
  MANAGED_RENDER_WORKFLOW: Workflow<
    Parameters<import("./index").ManagedRenderWorkflow["run"]>[0]["payload"]
  >;
}
