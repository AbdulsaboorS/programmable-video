/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example` (hash: 87f8bdb7f8b9bf4b572b4e0e2d2cb055)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "STUDIO_ORIGIN" | "PREVIEW_SIGNING_KEY">> {}
}
